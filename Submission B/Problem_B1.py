...
class myCallback(tf.keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs={}):
        # Use 1e-7 Because previous attempts were rejected Dicoding
...
def solution_B1():
    ...
    # YOUR CODE HERE
    # Try to use activation=None if rejected
    model = tf.keras.models.Sequential([keras.layers.Dense(1, input_shape=[1]), keras.layers.Dense(1)])
